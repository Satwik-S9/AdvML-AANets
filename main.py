...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', default='birds', type=str, choices=['cifar100', 'imagenet_sub', 'imagenet', 'birds'])
    parser.add_argument('--data_dir', default='/home/satwik/dev/academics/AdvML/Assignment2/src/data/birds', type=str)
    parser.add_argument('--baseline', default='icarl', type=str, choices=['lucir', 'icarl'], help='baseline method')
    ...
    parser.add_argument('--test_batch_size', default=64, type=int, help='the batch size for test loader')
    parser.add_argument('--eval_batch_size', default=64, type=int, help='the batch size for validation loader')
    ...
    parser.add_argument('--num_classes', default=450, type=int, help='the total number of classes')
    parser.add_argument('--nb_cl_fg', default=250, type=int, help='the number of classes in the 0-th phase')
    parser.add_argument('--nb_cl', default=50, type=int, help='the number of classes for each phase')
    parser.add_argument('--nb_protos', default=50, type=int, help='the number of exemplars for each class')
