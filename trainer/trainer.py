...
import pickle
import math
import parent.utils.misc
import parent.models.modified_resnet_cifar as modified_resnet_cifar
import parent.models.modified_resnetmtl_cifar as modified_resnetmtl_cifar
import parent.models.modified_resnet as modified_resnet
import parent.models.modified_resnetmtl as modified_resnetmtl
import parent.models.modified_linear as modified_linear
from parent.utils.imagenet.utils_dataset import split_images_labels
from parent.utils.imagenet.utils_dataset import merge_images_labels
from parent.utils.incremental.compute_accuracy import compute_accuracy
from parent.trainer.incremental_lucir import incremental_train_and_eval as incremental_train_and_eval_lucir
from parent.trainer.incremental_icarl import incremental_train_and_eval as incremental_train_and_eval_icarl
from parent.trainer.zeroth_phase import incremental_train_and_eval_zeroth_phase as incremental_train_and_eval_zeroth_phase
from parent.utils.misc import process_mnemonics
...
class Trainer(BaseTrainer):
    def train(self):
        ...
        for iteration in range(start_iter, int(self.args.num_classes/self.args.nb_cl)):
            ...
            trainloader, testloader = self.update_train_and_valid_loader(X_train, map_Y_train, X_valid_cumul, map_Y_valid_cumul, iteration, start_iter)
